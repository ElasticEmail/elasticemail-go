...
**EventType** | Pointer to [**EventType**](EventType.md) | Type of an Event | [optional] 
**EventDate** | Pointer to **time.Time** | Creation date | [optional] 
**ChannelName** | Pointer to **string** | Name of selected channel. | [optional] 
**MessageCategory** | Pointer to [**MessageCategory**](MessageCategory.md) | Message category | [optional] 
