...
type MergeEmailPayload struct {
	...
	MergeFile *MessageAttachment `json:"MergeFile,omitempty"`
...
// GetMergeFile returns the MergeFile field value if set, zero value otherwise.
func (o *MergeEmailPayload) GetMergeFile() MessageAttachment {
	if o == nil || o.MergeFile == nil {
...
// GetMergeFileOk returns a tuple with the MergeFile field value if set, nil otherwise
...
// SetMergeFile gets a reference to the given MessageAttachment and assigns it to the MergeFile field.
