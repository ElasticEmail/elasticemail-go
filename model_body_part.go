...
type BodyPart struct {
	...
	ContentType *BodyContentType `json:"ContentType,omitempty"`
...
// SetContentType gets a reference to the given BodyContentType and assigns it to the ContentType field.
